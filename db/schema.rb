...
ActiveRecord::Schema.define(version: 2018_11_02_043941) do
  ...
  create_table "asset_change_logs", force: :cascade do |t|
    ...
    t.index ["op_type"], name: "index_asset_change_logs_on_op_type"
    t.index ["user_id", "asset_name"], name: "index_asset_change_logs_on_user_id_and_asset_name"
    t.index ["user_id"], name: "index_asset_change_logs_on_user_id"
  end
  ...
  create_table "pending_assets", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "asset_name", null: false
    t.decimal "amount", precision: 15, scale: 5
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "asset_name"], name: "index_pending_assets_on_user_id_and_asset_name", unique: true
    t.index ["user_id"], name: "index_pending_assets_on_user_id"
  end
